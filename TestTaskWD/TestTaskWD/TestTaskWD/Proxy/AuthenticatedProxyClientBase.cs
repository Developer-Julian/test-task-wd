...
namespace TestTaskWD.Proxy
{
    ...
    internal abstract class AuthenticatedProxyClientBase
    {
        private readonly AuthenticatedProxyClientConfiguration configuration;

        private readonly IProxySerializer serializer;

        private readonly IProxyHttpClient httpClient;

        protected AuthenticatedProxyClientBase(
        ...
        {
            definition.Headers.Add(new KeyValuePair<string, string>("Authorization", $"ApiKey {this.configuration.ApiKey}"));
